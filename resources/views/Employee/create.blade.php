...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // On récupère les erreurs proprement via Blade
        let errorMessages = `
            <div style="text-align: left; padding-left: 10px;">
                @foreach ($errors->all() as $error)
                    <div class="mb-1"> <i class="bi bi-exclamation-circle-fill me-2"></i> {{ $error }}</div>
                @endforeach
            </div>
        `;
        ...
        Swal.fire({
            ...
            customClass: {
                ...
                title: 'text-danger py-3',
                confirmButton: 'px-5 py-2 fw-bold text-uppercase'
            }
        });
    });
</script>
